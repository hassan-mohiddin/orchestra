...
- [ ] **A11.** Pytest target: LLD-009 r3 baseline (**213**, updated from r2's 206 per LLD-009 r3 Changelog — added T4g/T4h + T10b-strict-a/b/c) + LLD-010 new tests (**27 distinct test functions**) → **≥240** (combined v1.7.0 target). Enumeration: T1=1; T2=1; T3a-d=4; T4a-g=7 (added T4g hybrid stale-script false-PASS regression); T5a-h=8 (added T5g + T5h transactional rollback); T6a-d=4; T7a-b=2; T8=1; T-INT-010=1 → 27.
