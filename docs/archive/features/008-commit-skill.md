...
> **Type:** Feature LLD
> **Status:** Rejected
> **Reason:** A3 file-enumeration contract drift — attestation-template.yaml relocated from cli/templates/ to skills/spec-review/templates/ per architectural cleanup. Cannot narrow-change A3 list on canon-frozen LLD; supersession required.
> **Superseded by:** docs/features/008-commit-skill-r8.md
> **Iteration:** 7
