...
def lint_doc(path: Path) -> list[Finding]:
    ...
    # Auto-generated index exemption (e.g. docs/adr/DECISIONS.md from
    # `cli.decisions_index`). These are machine-rendered overviews, not
    # authored docs; skip metadata + section enforcement.
    if "Auto-generated by" in head or "Auto-generated:" in head:
        return findings
