...
- [ ] **A16.** Pytest target: LLD-008 r7 baseline (**167**, updated from r6's 166 per LLD-008 r7 Changelog — added T5g + corrected A10 prose) + LLD-009 new tests (**51 distinct test functions**) = **≥218**. Enumeration: T1a-e=5; T2a-f=6; T3a-h=8; T4a-h=8; T5a-c=3; T6=1; T7a-c=3; T8=1; T9a-c=3; T10a-g=7 (added T10g for multi-var CI detection per plan-r2 codex HIGH#2); T10b-strict-a/b/c=3; T11=1; T12=1; T13-pre=1 → 51. All three numbers cite 51 / ≥218. Combined v1.7.0 target after LLD-010 r4 ships = 248 (Plan r3 absorbs cascade).
...
Total: **51 distinct test functions** across 13 test groups (added T10g r5 for multi-var CI detection).
