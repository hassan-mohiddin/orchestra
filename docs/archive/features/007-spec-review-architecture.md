...
> **Status:** Rejected
> **Iteration:** 4
> **Reason:** Dogfood (r4) found 13 substantive findings requiring body edits across A1, A5, A12, A14, Problem Statement, Bias mitigations, Edge Cases, Design § cli.spec_review module, and Changelog. Per LLD-006-r4 § narrow change, canon-frozen body edits require supersession not in-place. This doc archived; supersession at `docs/features/007-spec-review-architecture-r5.md`.
> **Superseded by:** docs/features/007-spec-review-architecture-r5.md
